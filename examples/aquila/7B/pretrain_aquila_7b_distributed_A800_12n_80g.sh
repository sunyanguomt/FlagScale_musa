...
LMDIR=/home/dist/cai/LM
DATASET=/home/dist/dataset/pile/pile_wikipedia_demo #$LMDIR/wiki2/ #"1 ${DATASET_1}"
CHECKPOINT_PATH=./ckpt
TOKENIZER_PATH=$LMDIR/llama2_config #
...
#--train-samples 1002539063 192000
#--use-flash-attn
...
cmd="torchrun $DISTRIBUTED_ARGS /home/dist/FlagScale/pretrain_gpt.py \
              $TRAINING_ARGS \
              $MIXED_PRECISION_ARGS \
              $DATA_ARGS \
              $NETWORK_ARGS \
