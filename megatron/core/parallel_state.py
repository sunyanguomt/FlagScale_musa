...
def initialize_model_parallel(
    ...
    for i in range(pipeline_model_parallel_size):
        ...
        for j in range(tensor_model_parallel_size):
            ...
            if rank in ranks:
                logger.info(f'data parallel {rank}, {",".join([str(i) for i in ranks])}')
    ...
    if use_sharp:
        ...
        torch.distributed.barrier(
            group=get_data_parallel_group(), device_ids=[torch.musa.current_device()]
        )
    ...
    for i in range(data_parallel_size):
        ...
        group = torch.distributed.new_group(ranks)
        if rank in ranks:
            logger.info(f'model parallel {rank}, {",".join([str(i) for i in ranks])}')
    ...
    for i in range(num_tensor_model_parallel_groups):
        ...
        group = torch.distributed.new_group(ranks)
        if rank in ranks:
            logger.info(f'tensor parallel {rank}, {",".join([str(i) for i in ranks])}')
    ...
    for i in range(num_pipeline_model_parallel_groups):
        ...
        group = torch.distributed.new_group(ranks)
        if rank in ranks:
            logger.info(f'pipeline parallel {rank}, {",".join([str(i) for i in ranks])}')
        ...
        if rank in ranks:
            logger.info(f'emebdding parallel {rank}, {",".join([str(i) for i in ranks])}')
