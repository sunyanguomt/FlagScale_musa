...
def report_memory(name):
    ...
    string += " | allocated: {}".format(torch.musa.memory_allocated() / mega_bytes)
    string += " | max allocated: {}".format(
        torch.musa.max_memory_allocated() / mega_bytes
    )
    string += " | reserved: {}".format(torch.musa.memory_reserved() / mega_bytes)
    string += " | max reserved: {}".format(
        torch.musa.max_memory_reserved() / mega_bytes
    )
