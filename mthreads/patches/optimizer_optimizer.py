...
from megatron.optimizer.optimizer import (
...
def MixedPrecisionOptimizer_init(
    self,
    optimizer,
    clip_grad,
...
megatron.optimizer.optimizer.Float16OptimizerWithFloat16Params.__init__ = (
    Float16OptimizerWithFloat16Params_init
)
megatron.optimizer.Float16OptimizerWithFloat16Params.__init__ = (
    Float16OptimizerWithFloat16Params_init
)
