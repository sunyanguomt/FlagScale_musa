...
export MUSA_ERROR_DUMP_PATH=/home/dist/qiyulei/
export MUSA_PRINT_ENV=1
export NCCL_PEER_ACCESS_IPC_FLAG=5
export NCCL_PEER_ACCESS_FLAG=4
export CUDA_DEVICE_MAX_CONNECTIONS=1
export PYTHONPATH=$PYTHONPATH:/home/dist/qiyulei/FlagScale
...
export MAAS_MODEL_PARAMETER="7b"
...
# ASYNC_CKPT_LOCAL_DIR="/data/ckpt-cache"
# ASYNC_CKPT_MEM_DIR="/dev/shm"
...
cmd="torchrun $DISTRIBUTED_ARGS /home/dist/qiyulei/FlagScale/megatron/pretrain_gpt.py \
              $TRAINING_ARGS \
              $MIXED_PRECISION_ARGS \
              $DATA_ARGS \
              $NETWORK_ARGS \
