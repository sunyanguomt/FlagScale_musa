...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/mpi/gcc/openmpi-4.1.5rc2/lib:/home/apex/amp_C/lib
# NCCL_IB_QPS_PER_CONNECTION = 20
# NCCL_IB_GID_INDEX = 3
# NCCL_IB_TC = 123
...
#DATA_FILE_PREFIX=${MODEL_STUDIO_DATAFILE_PREFIX}
...
#     --save $CHECKPOINT_PATH \
#     --load $CHECKPOINT_PATH
ASYNC_CKPT_LOCAL_DIR=${MODEL_STUDIO_CHECKPOINT_CACHE_DIR}  # 本地盘存储目录
ASYNC_CKPT_MEM_DIR="/dev/shm" # 内存
 
ASYNC_CKPT_ARGS="
   --enable_async_ckpt \
   --local_dir $ASYNC_CKPT_LOCAL_DIR \
...
LOGGING_ARGS="
    ...
    --log-params-norm
"
bash /home/dist/model-studio/FlagScale/aquila/gpu_monitor.sh &
