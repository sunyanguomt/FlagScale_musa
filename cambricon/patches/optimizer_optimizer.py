...
def MixedPrecisionOptimizerInit(
    self,
    optimizer,
    clip_grad,
...
def _unscale_main_grads_and_check_for_nan(self):
    ...
    output = torch.ops.torch_mlu.amp_unscale(
        main_grads, self.found_inf, self.grad_scaler.inv_scale
    )
...
megatron.optimizer.optimizer.MixedPrecisionOptimizer.__init__ = (
    MixedPrecisionOptimizerInit
)
